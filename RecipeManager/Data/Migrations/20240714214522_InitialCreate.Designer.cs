...
namespace RecipeManager.Data.Migrations
{
    ...
    [Migration("20240714214522_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipeManager.Models.MealPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RecipeManager.Models.Recipe", b =>
                {
                    b.HasOne("RecipeManager.Models.Ingredient", null)
                        .WithMany("Recipes")
                        .HasForeignKey("IngredientId");

                    b.HasOne("RecipeManager.Models.MealPlan", null)
                        .WithMany("Recipes")
